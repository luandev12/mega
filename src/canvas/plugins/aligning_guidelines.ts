...
function initAligningGuidelines(canvas) {
  ...
  canvas.on('object:moving', function(e) {
    var activeObject = e.target,
      ...
      activeObjectHeight = activeObjectBoundingRect.height / canvas.viewportTransform[3],
      activeObjectWidth = activeObjectBoundingRect.width / canvas.viewportTransform[0],
    ...
    for (var i = canvasObjects.length; i--; ) {
      ...
      var objectCenter = canvasObjects[i].getCenterPoint(),
        ...
        objectHeight = objectBoundingRect.height / canvas.viewportTransform[3],
        objectWidth = objectBoundingRect.width / canvas.viewportTransform[0];

...
const RectPro = fabric.util.createClass(fabric.Rect, {
	type: 'rectPro',
...
RectPro.fromObject = (options: any, callback: (obj: any) => any) => {
	return callback(new RectPro(options));
};

var windowFabric: any = window.fabric;
windowFabric.RectPro = RectPro;

...
const TextBoxPro = fabric.util.createClass(fabric.Group, {
  ...
  initialize : function(options: any) {
    ...
    this.fills = (options.fills && options.fills.length > 0) ? options.fills : [{ fill: options.fill.slice(0, 7), id: 1 }]
    var txtFilter;
    var defaultss = {
      ...
      stroke : `${options.stroke.slice(0, 7)}${percentToHex(options.opacityStroke || 100)}` || "#000000",
      lockScalingFlip: true,
      globalCompositeOperation: 'source-atop',
      fill: `${options.fill.slice(0, 7)}${percentToHex(options.opacityFill || 100)}`|| "#000000",
  ...
  _sanitizeFontFamily : function(qNameAsString: any) {
    return qNameAsString.indexOf("'") < 0 && (qNameAsString = "'" + qNameAsString + "'"), qNameAsString;
  },

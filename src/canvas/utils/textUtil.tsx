...
export const capFirstLetter = ({ s }: CapFirstLetter) => {
...
interface CanvasRenderingContext2D {
  lineMetrics: any;
  lastDrawnData: any;
  opentypeStroke: string;
  opentypeStrokeWidth: number;
  lineSpacing: number;
  ligatures: boolean;
  strokeRenderingCanvas: any;
  getFontSize: () => void;
  getFontFamily: () => void;
}
...
export function draw(
  character: string,
  font: any,
  strokeRenderingCanvas: HTMLCanvasElement,
  opentypeStrokeWidth: number,
  kerning: boolean,
  tracking: number,
 ...
 * @return {undefined}
 */
export function render(paths: any, ctx: any, isStroke: boolean, value: any) {
  ctx.beginPath();
